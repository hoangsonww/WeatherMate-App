...
module.exports = {
    ...
    bootstrap: function () {
        ...
        modulemapper.clobbers('cordova/plugin/android/mobile-app', 'navigator.mobile-app');
...
function onMessageFromNative (msg) {
    ...
    switch (action) {
    // pause and resume are Android mobile-app life cycle events
    case 'backbutton':
    case 'menubutton':
    case 'searchbutton':
    case 'pause':
...
// file: ../../cordova-js-src/plugin/android/mobile-app.js
define("cordova/plugin/android/mobile-app", function(require, exports, module) {
...
module.exports = {
    ...
    *
    * Example:
    *      navigator.mobile-app.loadUrl("http://server/myapp/index.html", {wait:2000, loadingDialog:"Wait,Loading App", loadUrlTimeoutValue: 60000});
    */
    ...
    * Instead of BACK button loading the previous web page, it will exit the mobile-app.
    */
